...
function displayProducts() {
    ...
    filteredProducts.forEach(product => {
        ...
        let imageSrc = window.googleSheetsUtils.fixImageUrl(product.image) || window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg');
        let altImageSrc = window.googleSheetsUtils.fixImageUrl(product.altImage) || window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg');
        
        productCard.innerHTML = `
            <div class="product-image">
                <div class="image-container">
                    <img src="${imageSrc}" alt="${product.name}" class="main-image active loaded" onerror="this.src=window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg')">
                    <img src="${altImageSrc}" alt="${product.name} - Alternativa" class="alt-image" onerror="this.src=window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg')">
                </div>
