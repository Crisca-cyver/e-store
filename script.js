...
function displayProducts() {
    ...
    filteredProducts.forEach(product => {
        ...
        const imageSrc = product.image && product.image.trim() !== '' ? 
            (window.googleSheetsUtils && typeof window.googleSheetsUtils.fixImageUrl === 'function' ? 
                window.googleSheetsUtils.fixImageUrl(product.image) : product.image) : 
        ...
        productCard.innerHTML = `
            <div class="product-image">
                <div class="image-container">
                    <img src="${imageSrc}" alt="${product.name}" class="main-image active loaded" onerror="this.src=(window.googleSheetsUtils && typeof window.googleSheetsUtils.fixImageUrl === 'function' ? window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg') : 'images/placeholder.jpg')">
                    <img src="${altImageSrc}" alt="${product.name} - Alternativa" class="alt-image" onerror="this.src=(window.googleSheetsUtils && typeof window.googleSheetsUtils.fixImageUrl === 'function' ? window.googleSheetsUtils.fixImageUrl('images/placeholder.jpg') : 'images/placeholder.jpg')">
                </div>
